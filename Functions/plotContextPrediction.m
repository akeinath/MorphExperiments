function binned_out = plotContextPrediction(val,sim,root,maxDays)
    ...
    saveFig(gcf,[root 'ContextGroupPrediction_Accuracy'],[{'tiff'} {'pdf'} {'jpeg'}])
    ...
    saveFig(gcf,[root 'ContextGroupPrediction_Accuracy_Bar'],[{'tiff'} {'pdf'} {'jpeg'}])
    binned_out = toPlot;
    ...
    xlabel('Lag from training set')
    legend(h(1,:),[{'1st'} {'2nd'} {'3rd'} {'4th'}],'location','southeast')
    saveFig(gcf,[root 'ContextGroupPrediction_Similarity'],[{'tiff'} {'pdf'} {'jpeg'}])
