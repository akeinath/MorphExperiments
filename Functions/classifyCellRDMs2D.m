function [outPenalty tr2] = classifyCellRDMswInteract2D(sim,RDMs,root)
    ...
    overallTR2 = tr2(1,:);
    overallColor = [0 0.25 1].*overallR2Penalty(2) + ...
        [1 0 0].*overallR2Penalty(1);
    r2penalty(1,:) = [];
    tr2(1,:) = [];
    
    outPenalty = r2penalty;
    ...
    saveFig(gcf,[root '/Classification/Dropout_2D_r2'],[{'pdf'} {'tiff'}])
end